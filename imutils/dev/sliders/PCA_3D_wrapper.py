...
features = np.arange(25, 70)  # Separating out the features (starting bodypart, ending bodypart)
...
def plot_3d_pca(x,y,z,cross_product_array, start_frame,end_frame):
    ...
    ax.scatter(x[start_frame:end_frame], y[start_frame:end_frame], z[start_frame:end_frame],
               c=cross_product_array[start_frame:end_frame], s=.25, vmin=-4e-4, vmax=4e-4, cmap='bwr')
